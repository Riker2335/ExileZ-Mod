...
EZM_MaxSpawnDistance				= 140;              // Max distance a zombie should spawn from a player.
EZM_MaxDistance						= 250;              // Max distance to players before delete.
EZM_MaxTime							= 10;               // Max time away from a player before delete.
...
EZM_TriggerGroupScaling				= 0.25;				// 1 player = Groupsize, 2 player in trigger = Groupsize + (GroupSize * TriggerGroupScalling * number of player in the trigger) set at 0 to disable scaling

// Night settings
EZM_LightsOff						= false;             // Kill all the light on map except the player lights.           
EZM_NightStartTime					= 20;               // Time at which it is night in hours
...
EZM_ZombieMaxMoney					= 100;               // Max Money per zombie kill-random amount put on corpses

// Stats settings
EZM_EnableStatKill					= true;				// Enable stat tracking for Kills DB entry
...
EZM_ryanzombieshealth						= 0.87;		// Health, *(initial damage level 0 is no damage 1 is dead)
EZM_ryanzombieshealthdemon					= 0.79;		// Health, *(initial damage level 0 is no damage 1 is dead)
...
EZM_ryanzombiesdamagecar					= 0.01;		// Attack damage to car *(% of car health per hit, 1 is 100%)
EZM_ryanzombiesdamageair					= 0.008;	// Attack damage to air *(% of car health per hit, 1 is 100%)
EZM_ryanzombiesdamagetank					= 0.001;	// Attack damage to tank *(% of car health per hit, 1 is 100%)
EZM_ryanzombiesdamagecarstrenth				= 0.8;		// Car attack strength *(Knockback strength in M/S)
EZM_ryanzombiesdamageairstrenth				= 0.2;		// Air attack strength *(Knockback strength M/S)
EZM_ryanzombiesdamagetankstrenth			= 0.1;		// Tank attack strength *(Knockback strength M/S)
...
EZM_ryanzombiescanthrowdemon				= 0;		// Enable or disable Throwing for demons
EZM_ryanzombiescanthrowtankdemon			= 0;		// Enable or disable Throwing tank for demons
EZM_ryanzombiescanthrowdistancedemon		= 10;		// Max throw distance demon
EZM_ryanzombiescanthrowtankdistancedemon	= 2;		// Max throw distance for tanks      
...
EZM_ryanzombiesinfectedchance				= 10;		// Precent chances to be infected on hit (Default 0)
EZM_ryanzombiesinfectedrate					= 0.025;	// Damage per minute when infected (+/- 30 minutes to live)
...
EZM_ryanzombiesantivirusduration			= 600;		// Antivirus duration *(5 minutes)
...
EZM_HarassingZedChance						= 70;		// Percent chance per player for a harassing Zed to spawn on them
EZM_HarassingZombieAtNightOnly				= true;		// Spawn harassing zombies at night only.
EZM_HarassingLoopTime						= 300;		// Check for players to harass every X seconds (Default 180 seconds)
EZM_HarassingConfig = [
...
// Hordes Config
EZM_UseHorde								= false;		// Use the horde spawner  
